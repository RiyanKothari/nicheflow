...
const NAV_GROUPS = [
  ...
  },
  {
    label: 'Manage',
    items: [
      { name: 'Bookings', path: '/bookings', icon: CalendarCheck, badge: 2 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Tasks', path: '/tasks', icon: CheckSquare, badge: 5 },
    ],
  },
  {
    label: 'Grow',
                  ...
                  >
                    ...
                    {isExpanded && item.badge && (
                      <motion.div 
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="ml-auto flex items-center justify-center h-4 min-w-4 px-1 bg-[rgba(245,158,11,0.20)] rounded-full text-[10px] font-bold text-[#F59E0B]"
                      >
                        {item.badge}
                      </motion.div>
                    )}
